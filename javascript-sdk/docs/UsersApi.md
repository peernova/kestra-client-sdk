...
let apiInstance = new KestraIoKestraSdk.UsersApi();
let id = "id_example"; // String | The user id
let iAMUserControllerApiPatchSuperAdminRequest = new KestraIoKestraSdk.IAMUserControllerApiPatchSuperAdminRequest(); // IAMUserControllerApiPatchSuperAdminRequest | 
