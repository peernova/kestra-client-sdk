...
*/
func (a *DefaultAPIService) Generate(ctx context.Context, tenant string) ApiGenerateRequest {
	return ApiGenerateRequest{
		ApiService: a,
		ctx:        ctx,
		tenant:     tenant,
...
//
//	@return string
func (a *DefaultAPIService) GenerateExecute(r ApiGenerateRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.Generate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
