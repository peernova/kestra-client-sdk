...
class FlowWithSource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "namespace", "revision", "inputs", "outputs", "disabled", "labels", "variables", "deleted", "finally", "taskDefaults", "description", "tasks", "errors", "listeners", "afterExecution", "triggers", "pluginDefaults", "concurrency", "retry", "sla"]
