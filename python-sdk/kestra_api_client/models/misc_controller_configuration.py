...
class MiscControllerConfiguration(BaseModel):
    ...
    is_basic_auth_enabled: Optional[StrictBool] = Field(default=None, alias="isBasicAuthEnabled")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "version", "commitId", "commitDate", "isCustomDashboardsEnabled", "isTaskRunEnabled", "isAnonymousUsageEnabled", "isTemplateEnabled", "environment", "url", "preview", "isBasicAuthEnabled", "systemNamespace", "hiddenLabelsPrefixes", "resourceToFilters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isBasicAuthEnabled": obj.get("isBasicAuthEnabled"),
