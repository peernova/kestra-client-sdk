...
|------------- | ------------- | -------------|
| [**enterMaintenance**](ClusterApi.md#enterMaintenance) | **POST** /api/v1/{tenant}/cluster/maintenance/enter | Enter cluster maintenance mode. |
| [**exitMaintenance**](ClusterApi.md#exitMaintenance) | **POST** /api/v1/{tenant}/cluster/maintenance/exit | Exit cluster maintenance mode. |
...
import io.kestra.api.sdk.api.ClusterApi;
