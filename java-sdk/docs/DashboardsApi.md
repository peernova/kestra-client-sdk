...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            byte[] result = apiInstance.exportChartToCsv(tenant, dashboardControllerPreviewRequest);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            byte[] result = apiInstance.exportDashboardChartDataToCSV(id, chartId, tenant, chartFiltersOverrides);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        ChartFiltersOverrides chartFiltersOverrides = new ChartFiltersOverrides(); // ChartFiltersOverrides | The filters to apply, some can override chart definition like labels & namespace
        try {
            PagedResultsMapStringObject result = apiInstance.getDashboardChartData(id, chartId, tenant, chartFiltersOverrides);
            System.out.println(result);
        } catch (ApiException e) {
