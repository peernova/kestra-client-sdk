...
import io.kestra.api.sdk.model.ServiceUsageDailyStatistics;
...
public class ServiceUsageDailyServiceStatistics {
  ...
  public ServiceUsageDailyServiceStatistics type(@javax.annotation.Nonnull String type) {
  ...
  public ServiceUsageDailyServiceStatistics values(@javax.annotation.Nonnull List<ServiceUsageDailyStatistics> values) {
  ...
  @JsonProperty(JSON_PROPERTY_VALUES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValues(@javax.annotation.Nonnull List<ServiceUsageDailyStatistics> values) {
    this.values = values;
  }
