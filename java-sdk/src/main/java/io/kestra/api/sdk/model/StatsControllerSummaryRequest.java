 ...
 */
@JsonPropertyOrder({
  StatsControllerSummaryRequest.JSON_PROPERTY_NAMESPACE,
  StatsControllerSummaryRequest.JSON_PROPERTY_START_DATE,
  StatsControllerSummaryRequest.JSON_PROPERTY_END_DATE
})
@JsonTypeName("StatsController.SummaryRequest")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-12-31T15:48:45.246126227Z[Etc/UTC]", comments = "Generator version: 7.11.0-SNAPSHOT")
public class StatsControllerSummaryRequest {
  ...
  public StatsControllerSummaryRequest() {
  }

  public StatsControllerSummaryRequest namespace(@javax.annotation.Nullable String namespace) {
  ...
  public StatsControllerSummaryRequest startDate(@javax.annotation.Nullable OffsetDateTime startDate) {
  ...
  public StatsControllerSummaryRequest endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public boolean equals(Object o) {
    ...
    StatsControllerSummaryRequest statsControllerSummaryRequest = (StatsControllerSummaryRequest) o;
    return equalsNullable(this.namespace, statsControllerSummaryRequest.namespace) &&
        equalsNullable(this.startDate, statsControllerSummaryRequest.startDate) &&
        equalsNullable(this.endDate, statsControllerSummaryRequest.endDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatsControllerSummaryRequest {\n");
