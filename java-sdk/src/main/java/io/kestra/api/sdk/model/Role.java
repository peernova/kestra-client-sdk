...
import io.kestra.api.sdk.model.RolePermissions;
...
public class Role {
  ...
  public Role permissions(@javax.annotation.Nonnull RolePermissions permissions) {
  ...
  @JsonProperty(JSON_PROPERTY_PERMISSIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPermissions(@javax.annotation.Nonnull RolePermissions permissions) {
    this.permissions = permissions;
  }
