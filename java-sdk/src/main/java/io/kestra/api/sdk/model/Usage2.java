 ...
 */
@JsonPropertyOrder({
  Usage2.JSON_PROPERTY_UUID,
  Usage2.JSON_PROPERTY_START_UUID,
  Usage2.JSON_PROPERTY_INSTANCE_UUID,
  Usage2.JSON_PROPERTY_SERVER_TYPE,
  Usage2.JSON_PROPERTY_VERSION,
  Usage2.JSON_PROPERTY_ZONE_ID,
  Usage2.JSON_PROPERTY_URI,
  Usage2.JSON_PROPERTY_ENVIRONMENTS,
  Usage2.JSON_PROPERTY_START_TIME,
  Usage2.JSON_PROPERTY_HOST,
  Usage2.JSON_PROPERTY_CONFIGURATIONS,
  Usage2.JSON_PROPERTY_PLUGINS,
  Usage2.JSON_PROPERTY_FLOWS,
  Usage2.JSON_PROPERTY_EXECUTIONS,
  Usage2.JSON_PROPERTY_SERVICES,
  Usage2.JSON_PROPERTY_GROUPS,
  Usage2.JSON_PROPERTY_USERS,
  Usage2.JSON_PROPERTY_ROLES,
  Usage2.JSON_PROPERTY_NAMESPACES,
  Usage2.JSON_PROPERTY_TENANTS
})
@JsonTypeName("Usage_2")
...
public class Usage2 {
  ...
  public Usage2 uuid(@javax.annotation.Nonnull String uuid) {
  ...
  public Usage2 startUuid(@javax.annotation.Nonnull String startUuid) {
  ...
  public Usage2 instanceUuid(@javax.annotation.Nonnull String instanceUuid) {
  ...
  public Usage2 serverType(@javax.annotation.Nonnull ServerType serverType) {
  ...
  public Usage2 version(@javax.annotation.Nonnull String version) {
  ...
  public Usage2 zoneId(@javax.annotation.Nonnull String zoneId) {
  ...
  public Usage2 uri(@javax.annotation.Nullable String uri) {
  ...
  public Usage2 environments(@javax.annotation.Nullable List<String> environments) {
    
    this.environments = environments;
    return this;
  }

  public Usage2 addEnvironmentsItem(String environmentsItem) {
  ...
  public Usage2 startTime(@javax.annotation.Nonnull OffsetDateTime startTime) {
  ...
  public Usage2 host(@javax.annotation.Nonnull HostUsage host) {
  ...
  public Usage2 configurations(@javax.annotation.Nonnull ConfigurationUsage configurations) {
  ...
  public Usage2 plugins(@javax.annotation.Nonnull List<PluginUsage> plugins) {
    
    this.plugins = plugins;
    return this;
  }

  public Usage2 addPluginsItem(PluginUsage pluginsItem) {
  ...
  public Usage2 flows(@javax.annotation.Nonnull FlowUsage flows) {
  ...
  public Usage2 executions(@javax.annotation.Nonnull ExecutionUsage executions) {
  ...
  public Usage2 services(@javax.annotation.Nullable ServiceUsage services) {
  ...
  public Usage2 groups(@javax.annotation.Nullable GroupUsage groups) {
  ...
  public Usage2 users(@javax.annotation.Nullable UserUsage users) {
  ...
  public Usage2 roles(@javax.annotation.Nullable RoleUsage roles) {
  ...
  public Usage2 namespaces(@javax.annotation.Nullable NamespaceUsage namespaces) {
  ...
  public Usage2 tenants(@javax.annotation.Nullable TenantUsage tenants) {
  ...
  public boolean equals(Object o) {
    ...
    Usage2 usage2 = (Usage2) o;
    return Objects.equals(this.uuid, usage2.uuid) &&
        Objects.equals(this.startUuid, usage2.startUuid) &&
        Objects.equals(this.instanceUuid, usage2.instanceUuid) &&
        Objects.equals(this.serverType, usage2.serverType) &&
        Objects.equals(this.version, usage2.version) &&
        Objects.equals(this.zoneId, usage2.zoneId) &&
        Objects.equals(this.uri, usage2.uri) &&
        Objects.equals(this.environments, usage2.environments) &&
        Objects.equals(this.startTime, usage2.startTime) &&
        Objects.equals(this.host, usage2.host) &&
        Objects.equals(this.configurations, usage2.configurations) &&
        Objects.equals(this.plugins, usage2.plugins) &&
        Objects.equals(this.flows, usage2.flows) &&
        Objects.equals(this.executions, usage2.executions) &&
        Objects.equals(this.services, usage2.services) &&
        Objects.equals(this.groups, usage2.groups) &&
        Objects.equals(this.users, usage2.users) &&
        Objects.equals(this.roles, usage2.roles) &&
        Objects.equals(this.namespaces, usage2.namespaces) &&
        Objects.equals(this.tenants, usage2.tenants);
  }
