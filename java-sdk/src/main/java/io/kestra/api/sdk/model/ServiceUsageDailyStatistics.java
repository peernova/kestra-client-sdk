...
public class ServiceUsageDailyStatistics {
  ...
  public ServiceUsageDailyStatistics date(@javax.annotation.Nonnull LocalDate date) {
  ...
  public ServiceUsageDailyStatistics min(@javax.annotation.Nonnull Long min) {
  ...
  public ServiceUsageDailyStatistics max(@javax.annotation.Nonnull Long max) {
  ...
  public ServiceUsageDailyStatistics avg(@javax.annotation.Nonnull Long avg) {
  ...
  @JsonProperty(JSON_PROPERTY_AVG)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAvg(@javax.annotation.Nonnull Long avg) {
    this.avg = avg;
  }
