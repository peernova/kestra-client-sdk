...
import io.kestra.api.sdk.model.MiscControllerPluginIdAndVersion;
...
@JsonPropertyOrder({
  ...
  MiscControllerEEConfiguration.JSON_PROPERTY_IS_BASIC_AUTH_ENABLED,
...
public class MiscControllerEEConfiguration {
  ...
  public MiscControllerEEConfiguration isBasicAuthEnabled(@javax.annotation.Nullable Boolean isBasicAuthEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, miscControllerEEConfiguration.uuid) &&
        ...
        Objects.equals(this.isBasicAuthEnabled, miscControllerEEConfiguration.isBasicAuthEnabled) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, version, commitId, commitDate, isCustomDashboardsEnabled, isTaskRunEnabled, isAnonymousUsageEnabled, isTemplateEnabled, environment, url, preview, isBasicAuthEnabled, systemNamespace, hiddenLabelsPrefixes, resourceToFilters, tenants, secretsEnabled, supportedStorages, supportedSecrets, pluginManagementEnabled, pluginCustomEnabled, banner, mailServiceEnabled, outputsInInternalStorageEnabled);
  }
