 ...
 */
@JsonPropertyOrder({
  SequencedCollectionObject.JSON_PROPERTY_EMPTY,
  SequencedCollectionObject.JSON_PROPERTY_FIRST,
  SequencedCollectionObject.JSON_PROPERTY_LAST
})
@JsonTypeName("SequencedCollection_Object_")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-12-31T15:48:45.246126227Z[Etc/UTC]", comments = "Generator version: 7.11.0-SNAPSHOT")
public class SequencedCollectionObject {
  ...
  @javax.annotation.Nullable
  private JsonNullable<Object> first = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_LAST = "last";
  @javax.annotation.Nullable
  private JsonNullable<Object> last = JsonNullable.<Object>of(null);

  public SequencedCollectionObject() {
  }

  public SequencedCollectionObject empty(@javax.annotation.Nullable Boolean empty) {
  ...
  public SequencedCollectionObject first(@javax.annotation.Nullable Object first) {
  ...
  public SequencedCollectionObject last(@javax.annotation.Nullable Object last) {
  ...
  public boolean equals(Object o) {
    ...
    SequencedCollectionObject sequencedCollectionObject = (SequencedCollectionObject) o;
    return Objects.equals(this.empty, sequencedCollectionObject.empty) &&
        equalsNullable(this.first, sequencedCollectionObject.first) &&
        equalsNullable(this.last, sequencedCollectionObject.last);
  }
  ...
  public String toString() {
    ...
    sb.append("class SequencedCollectionObject {\n");
