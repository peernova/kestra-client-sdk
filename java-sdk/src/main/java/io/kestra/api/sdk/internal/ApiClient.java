...
import io.kestra.api.sdk.internal.auth.Authentication;
import io.kestra.api.sdk.internal.auth.HttpBasicAuth;
import io.kestra.api.sdk.internal.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    public ApiClient(CloseableHttpClient httpClient) {
        ...
        setUserAgent("OpenAPI-Generator/v0.23.0/java");
    ...
    public <T> T deserialize(CloseableHttpResponse response, TypeReference<T> valueType) throws
     ...
     * @return The full URL
     */
    protected String buildUrl(String path, List<Pair> queryParams, List<Pair> collectionQueryParams, String
        urlQueryDeepObject) {
    ...
    protected <T> T processResponse(CloseableHttpResponse response, TypeReference<T> returnType) throws
        ApiException, IOException, ParseException {
    ...
    protected void updateParamsForAuth(String[]
                                           authNames, List<Pair> queryParams, Map<String, String> headerParams, Map<String, String> cookieParams) {
