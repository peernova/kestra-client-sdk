...
public class Usage {
  ...
  public Usage host(@javax.annotation.Nonnull HostUsage host) {
  ...
  public Usage configurations(@javax.annotation.Nonnull ConfigurationUsage configurations) {
  ...
  public Usage plugins(@javax.annotation.Nonnull List<PluginUsage> plugins) {
  ...
  public Usage flows(@javax.annotation.Nonnull FlowUsage flows) {
  ...
  public Usage executions(@javax.annotation.Nonnull ExecutionUsage executions) {
