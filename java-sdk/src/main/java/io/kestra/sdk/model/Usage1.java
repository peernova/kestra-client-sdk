 ...
 */
@JsonPropertyOrder({
  Usage1.JSON_PROPERTY_UUID,
  Usage1.JSON_PROPERTY_START_UUID,
  Usage1.JSON_PROPERTY_INSTANCE_UUID,
  Usage1.JSON_PROPERTY_SERVER_TYPE,
  Usage1.JSON_PROPERTY_VERSION,
  Usage1.JSON_PROPERTY_ZONE_ID,
  Usage1.JSON_PROPERTY_URI,
  Usage1.JSON_PROPERTY_ENVIRONMENTS,
  Usage1.JSON_PROPERTY_START_TIME,
  Usage1.JSON_PROPERTY_HOST,
  Usage1.JSON_PROPERTY_CONFIGURATIONS,
  Usage1.JSON_PROPERTY_PLUGINS,
  Usage1.JSON_PROPERTY_FLOWS,
  Usage1.JSON_PROPERTY_EXECUTIONS,
  Usage1.JSON_PROPERTY_SERVICES,
  Usage1.JSON_PROPERTY_GROUPS,
  Usage1.JSON_PROPERTY_USERS,
  Usage1.JSON_PROPERTY_ROLES,
  Usage1.JSON_PROPERTY_NAMESPACES,
  Usage1.JSON_PROPERTY_TENANTS
})
@JsonTypeName("Usage_1")
...
public class Usage1 {
  ...
  public Usage1 uuid(@javax.annotation.Nonnull String uuid) {
  ...
  public Usage1 startUuid(@javax.annotation.Nonnull String startUuid) {
  ...
  public Usage1 instanceUuid(@javax.annotation.Nonnull String instanceUuid) {
  ...
  public Usage1 serverType(@javax.annotation.Nonnull ServerType serverType) {
  ...
  public Usage1 version(@javax.annotation.Nonnull String version) {
  ...
  public Usage1 zoneId(@javax.annotation.Nonnull String zoneId) {
  ...
  public Usage1 uri(@javax.annotation.Nullable String uri) {
  ...
  public Usage1 environments(@javax.annotation.Nullable List<String> environments) {

    this.environments = environments;
    return this;
  }

  public Usage1 addEnvironmentsItem(String environmentsItem) {
  ...
  public Usage1 startTime(@javax.annotation.Nonnull OffsetDateTime startTime) {
  ...
  public Usage1 host(@javax.annotation.Nonnull HostUsage host) {
  ...
  public Usage1 configurations(@javax.annotation.Nonnull ConfigurationUsage configurations) {
  ...
  public Usage1 plugins(@javax.annotation.Nonnull List<PluginUsage> plugins) {

    this.plugins = plugins;
    return this;
  }

  public Usage1 addPluginsItem(PluginUsage pluginsItem) {
  ...
  public Usage1 flows(@javax.annotation.Nonnull FlowUsage flows) {
  ...
  public Usage1 executions(@javax.annotation.Nonnull ExecutionUsage executions) {
  ...
  public Usage1 services(@javax.annotation.Nullable ServiceUsage services) {
  ...
  public Usage1 groups(@javax.annotation.Nullable GroupUsage groups) {
  ...
  public Usage1 users(@javax.annotation.Nullable UserUsage users) {
  ...
  public Usage1 roles(@javax.annotation.Nullable RoleUsage roles) {
  ...
  public Usage1 namespaces(@javax.annotation.Nullable NamespaceUsage namespaces) {
  ...
  public Usage1 tenants(@javax.annotation.Nullable TenantUsage tenants) {
  ...
  public boolean equals(Object o) {
    ...
    Usage1 usage1 = (Usage1) o;
    return Objects.equals(this.uuid, usage1.uuid) &&
        Objects.equals(this.startUuid, usage1.startUuid) &&
        Objects.equals(this.instanceUuid, usage1.instanceUuid) &&
        Objects.equals(this.serverType, usage1.serverType) &&
        Objects.equals(this.version, usage1.version) &&
        Objects.equals(this.zoneId, usage1.zoneId) &&
        Objects.equals(this.uri, usage1.uri) &&
        Objects.equals(this.environments, usage1.environments) &&
        Objects.equals(this.startTime, usage1.startTime) &&
        Objects.equals(this.host, usage1.host) &&
        Objects.equals(this.configurations, usage1.configurations) &&
        Objects.equals(this.plugins, usage1.plugins) &&
        Objects.equals(this.flows, usage1.flows) &&
        Objects.equals(this.executions, usage1.executions) &&
        Objects.equals(this.services, usage1.services) &&
        Objects.equals(this.groups, usage1.groups) &&
        Objects.equals(this.users, usage1.users) &&
        Objects.equals(this.roles, usage1.roles) &&
        Objects.equals(this.namespaces, usage1.namespaces) &&
        Objects.equals(this.tenants, usage1.tenants);
  }
