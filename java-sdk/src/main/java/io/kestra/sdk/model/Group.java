...
import io.kestra.sdk.model.IdentityProvider;
...
public class Group {
  ...
  public Group provider(@javax.annotation.Nullable IdentityProvider provider) {
  ...
  @JsonProperty(JSON_PROPERTY_PROVIDER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProvider(@javax.annotation.Nullable IdentityProvider provider) {
    this.provider = provider;
  }
