...
public class UsageEE {
  ...
  public UsageEE host(@javax.annotation.Nonnull HostUsage host) {
  ...
  public UsageEE configurations(@javax.annotation.Nonnull ConfigurationUsage configurations) {
  ...
  public UsageEE plugins(@javax.annotation.Nonnull List<PluginUsage> plugins) {
  ...
  public UsageEE flows(@javax.annotation.Nonnull FlowUsage flows) {
  ...
  public UsageEE executions(@javax.annotation.Nonnull ExecutionUsage executions) {
